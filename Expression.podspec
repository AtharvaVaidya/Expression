...
Pod::Spec.new do |s|
  s.name             = 'Expression'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Expression.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/Expression'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'TechieCSG' => 'atharva.vaidya01@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/Expression.git', :tag => s.version.to_s }
